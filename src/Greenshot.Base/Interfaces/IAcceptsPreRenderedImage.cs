...
{
    /// <summary>
    /// Destinations that implement this interface can accept a pre-rendered bitmap,
    /// avoiding a redundant surface render pass when a shared bitmap is already available.
    /// </summary>
